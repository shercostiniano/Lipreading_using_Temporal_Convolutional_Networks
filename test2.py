...
sys.path.append(r"C:/Users/sherw/OneDrive/Desktop/Thesis/filipino-lipreading/VSR")
...
def main():
    ...
    parser.add_argument('--model-path', type=Path, default=Path('models/lrw_resnet18_mstcn_video.pth.tar'))
    ...
    # fa = FaceTracker(device="cpu", model="mediapipe")
    ...
    with VideoCapture(0) as cap:
        while True:
            ...
            # all_landmarks = fa.tracker(image_np)
            if all_landmarks:
